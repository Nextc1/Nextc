...
//     const handleKycDataChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
...
//                         <Input id="phoneNumber" value={user?.phone_number} readOnly />
//                     </div>
//                     <div>
    ...
    return (
        <div className="min-h-screen flex justify-center items-center bg-gray-100 p-4">
            <div className="w-full max-w-md bg-white rounded-lg shadow-md p-6">
                ...
                <div className="space-y-4">
                    {['first_name', 'last_name', 'email', 'phone_number', 'country'].map(field => (
                        <div key={field} className="flex items-center space-x-2 mb-4">
                            <div className="flex-1">
                                <Label htmlFor={field}>{capitalizeFirstLetter(field.replace('_', ' '))}</Label>
                                <Input
                                    id={field}
                                    value={editableField === field ? fieldValue : user?.[field] || ''}
                            ...
                            {editableField === field ? (
                                ...
                                <Button onClick={() => handleFieldEdit(field as keyof User)} className="ml-2">
                                    Edit
                                </Button>
                            )}
                        </div>
